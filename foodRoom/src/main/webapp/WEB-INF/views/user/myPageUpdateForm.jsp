...
<body>
	<div id="myPageUpdateField">
		<form method="post" name="myPageUpdateForm">
			<table class="myPageUpdateTable">
				...
				<tr>
					<td>아이디</td>
					<td><input type="text" name="fr_id" id="fr_id" value="${fr_id}" readonly/></td>
				</tr>
				<tr>
					<td>비밀번호</td>
				...
				<tr>
					<td>이름</td>
					<td><input type="text" name="fr_name" id="fr_name" value="${fr_name}"/></td>
				</tr>
				<tr>
					<td>연락처</td>
					<td><input type="text" name="fr_p_number" id="fr_p_number" value="${fr_p_number}"/></td>
				</tr>
				<tr>
					<td>이메일</td>
					<td><input type="text" name="fr_email" id="fr_email" value="${fr_email}" /></td>
				</tr>
				<tr>	
